(function () {
  ...
  describe('UserStatusMessages Controller Tests', function () {
    // Initialize global variables
    var UserStatusMessagesController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _UserStatusMessagesService_) {
